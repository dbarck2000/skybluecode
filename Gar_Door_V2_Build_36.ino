...
// Global constants 
// Max and Min current
const int D1_MAX_CURRENT_OPENING = 3000;        // if current exceeds this value while opening for an extended time, then stop 
const int D2_MAX_CURRENT_OPENING = 3000;        // if current exceeds this value while opening for an extended time, then stop 
const int D1_MAX_CURRENT_CLOSING = 3000;        // if current exceeds this value while closing for an extended time, then stop 
const int D2_MAX_CURRENT_CLOSING = 3000;        // if current exceeds this value while closing for an extended time, then stop 
const int D1_MAX_MILLIS_AT_OVERCURRENT = 250;   // max time the current can exceed the max current
const int D2_MAX_MILLIS_AT_OVERCURRENT = 250;   // max time the current can exceed the max current
...
const unsigned long MAX_RUNTIME_MILLIS = 13000; // max run time before timing out
const int START_RAMPDOWN_MILLIS = 13000;        // elapsed opening or closing time before starting to ramp the actuator speed down;
