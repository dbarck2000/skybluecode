...
// Global constants 
// Max and Min current
const int D1_MAX_CURRENT_OPENING = 4000;        // if current exceeds this value while opening for an extended time, then stop 
const int D2_MAX_CURRENT_OPENING = 4000;        // if current exceeds this value while opening for an extended time, then stop 
const int D1_MAX_CURRENT_CLOSING = 4000;        // if current exceeds this value while closing for an extended time, then stop 
const int D2_MAX_CURRENT_CLOSING = 4000;        // if current exceeds this value while closing for an extended time, then stop 
...
const unsigned long MAX_RUNTIME_MILLIS = 14000; // max run time before timing out
